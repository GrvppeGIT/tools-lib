...
func pickSignatureAlgorithm(certType x509.PublicKeyAlgorithm, alg string) (*algorithm, error) {
	...
	case x509.RSA:
		...
		case "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256":
			hash = crypto.SHA256
		default:
			return nil, errors.New("signxml does not currently the specfied algorithm for RSA certificates")
		}
	case x509.DSA:
		switch alg {
		case "":
		...
		case "http://www.w3.org/2009/xmldsig11#dsa-sha256":
			hash = crypto.SHA256
		default:
			return nil, errors.New("signxml does not currently the specfied algorithm for DSA certificates")
		}
	case x509.ECDSA:
		return nil, errors.New("signxml does not currently support ECDSA certificates")
	default:
		return nil, errors.New("signxml needs some work to support your certificate")
	}
...
func pickDigestAlgorithm(alg string) (*algorithm, error) {
	...
	return nil, errors.New("signxml does not support the specified digest algorithm")
}
